    ...
    <div class="content">
        ...
        <div class="editalInfo"  v-if="buttonClick ==1">
            <div class="content-box1">
                <div style="margin-top:24px;"><span class="icon-must"></span>登录名<span style="font-size:12px;color:red;">(输入英文字母或数字)</span></div>
            ...
            <div class="content-box1">
                ...
                <el-select v-model="city" placeholder="请选择" @change="cityChange" filterable class="halfWidth" style="margin-left:10px;" v-if=" width && province && cityOptions.length != 0 ">
                    <el-option
                ...
                <el-select v-model="county"  @change="countyChange" placeholder="请选择" filterable class="halfWidth" style="margin-left:10px;" v-if=" province &&city && countyOptions.length != 0">
                    <el-option
                ...
                <el-select v-model="countySide" placeholder="请选择" filterable class="halfWidth" style="margin-left:10px;" v-if="province && (province != root)&&county && countySideOptions.length != 0 ">
                    <el-option
            ...
            <div class="content-box1">
                ...
                <el-select v-model="newGuest.level" ref="level" placeholder="选择管理员类型" :disabled="quan" style="width:100%;">
                    <el-option
            ...
            <div class="content-box1">
                ...
                <el-select v-model="newGuest.alarmType"  :class="{'demo-select': isMore}" ref="alarmType" multiple  placeholder="选择报警类型" style="width:100%;">
                    <el-option
        ...
        <div class="editalInfo"  v-if="buttonClick ==2 && multipleSelection">
            ...
            <div class="content-box1">
                ...
                <el-select v-model="city" :disabled="edit" placeholder="请选择" @change="cityChange" class="halfWidth city" v-if=" province && width && cityOptions.length != 0">
                    <el-option
                        v-for="item in cityOptions"
                        :key="item.id"
                        :label="item.label"
                ...
                <el-select v-model="county" :disabled="edit" @change="countyChange"  placeholder="请选择" class="halfWidth county" v-if=" province && city && countyOptions.length != 0">
                    <el-option
                        v-for="item in countyOptions"
                        :key="item.id"
                        :label="item.label"
                ...
                <el-select v-model="countySide" :disabled="edit" placeholder="请选择"  class="halfWidth countySide" v-if="province && province != root && county && countySideOptions.length != 0">
                    <el-option
                        v-for="item in countySideOptions"
                        :key="item.id"
                        :label="item.label"
        ...
        <div class="confirm" style="text-align:right;margin:24px;">
            ...
            <el-button type="primary" @click="ok" :disabled="tongJi">确定</el-button>
        </div>
    </div>
</div>
</template>
                ...
                handler(newValue, oldValue) {
                    ...
                    for (let p in newValue) {
                        if (p != "areaId" && p != "alarmType") {
                            ...
                            this.$refs[p].$el.childNodes[1].style.border = "none";
                        }　　　　
                    }
                },
                　　deep: true
        ...
        mounted() {
            ...
            if (this.buttonClick == 1) {
                ...
                if(localStorage.getItem('fid') >= 4){
                    this.arr.splice(0,localStorage.getItem('fid')-1);
                }
                this.guests = [{
                    value: 10,
                    label: "普通管理员"
        ...
        methods: {
            ...
            ok() {
                ...
                if (this.buttonClick == 1) {
                    ...
                    this.newGuest.password = md5(this.newGuest.password);
